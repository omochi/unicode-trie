...
describe('unicode trie', () => {
  ...
  it('toBuffer written in little-endian', () => {
    ...
    const bufferExpected = new Buffer.from([0, 72, 0, 0, 0, 0, 0, 0, 128, 36, 0, 0, 237, 206, 49, 10, 192, 32, 12, 64, 81, 113, 234, 232, 216, 177, 99, 111, 161, 119, 233, 69, 123, 52, 3, 118, 239, 168, 224, 251, 240, 8, 153, 146, 146, 83, 58, 195, 21, 238, 80, 190, 125, 167, 9, 0, 172, 171, 46, 240, 3, 0, 0, 0, 0, 0, 240, 239, 61, 134, 54, 137, 164, 209, 51, 225, 102, 7]);
